...
You are given a **C\# software project** designed to implement some of the following **console-based game**:
...
High-Quality Code Team project – “Bulls and Cows” Game description
